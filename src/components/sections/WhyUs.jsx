      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <SectionHeader
            ...
            subtitle="YATA Distribution s'engage à offrir une expérience d'approvisionnement exceptionnelle grâce à des standards élevés de qualité et de service."
            light
          />
        </motion.div>
          ...
          {WHY_US.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="group bg-white/5 hover:bg-white/10 border border-white/10 hover:border-amber-400/40 rounded-2xl p-7 transition-all duration-300 cursor-default"
              >
