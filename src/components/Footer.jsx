        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 text-start">
            <div className="flex items-center gap-2.5 mb-5">
              <svg viewBox="0 0 100 100" className="w-10 h-10 shrink-0 filter drop-shadow-[0_2px_8px_rgba(37,99,235,0.25)]" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                ...
                {/* Blue head circle */}
                <circle cx="50" cy="21" r="9.5" fill="url(#blueGradFoot)" />

                {/* Green arm (left) */}
                <path d="M 46 32 C 34 23, 24 25, 24 35 C 24 43, 34 44, 44 38 C 47 36, 47 34, 46 32 Z" fill="url(#greenGradFoot)" />

                {/* Yellow arm (right & diagonal body) */}
                <path d="M 48 32 C 58 23, 70 17, 77 18 C 62 27, 52 42, 50 52 C 48 62, 51 72, 55 78 C 51 68, 48 56, 48 32 Z" fill="url(#yellowGradFoot)" />

                {/* Orange-Red bottom loop */}
                <path d="M 50 52 C 46 62, 38 70, 39 76 C 41 81, 48 81, 52 76 C 53 70, 51 60, 50 52 Z" fill="url(#orangeRedGradFoot)" />
              </svg>
