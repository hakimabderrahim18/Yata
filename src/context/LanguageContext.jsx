...
const DICTIONARY = {
  fr: {
    ...
    partnersFilterAll: "Tous",
    partnersFilterGrocery: "Épicerie & Alimentation",
    partnersFilterBeverage: "Boissons & Jus",
    partnersFilterHygiene: "Entretien & Hygiène",
    partnersDirectDist: "Distribution Directe",
    partnersDirectDistDesc: "Relations directes avec les plus grands producteurs pour des tarifs compétitifs sans intermédiaires.",
    partnersLogistic: "Logistique Normée",
    partnersLogisticDesc: "Flotte de camions modernes et dépôts de stockage répondant aux normes d'hygiène et de sécurité.",
    partnersStock: "Disponibilité Garantie",
    partnersStockDesc: "Gestion de stock en temps réel et réapprovisionnement ultra-rapide pour éviter les ruptures.",
    ...
    PARTNERS: [
      { name: 'Famico', logo: '', category: 'grocery', description: "Café torréfié, café soluble et produits d'épicerie fine." },
      { name: 'Jumbo', logo: '', category: 'grocery', description: "Bouillons en cubes, condiments et exhausteurs de goût incontournables." },
      { name: 'Amour', logo: '', category: 'grocery', description: "Pâtes alimentaires de qualité supérieure, couscous et semoules." },
      { name: 'Sosemie', logo: '', category: 'grocery', description: "Semoules de blé dur de premier choix et pâtes traditionnelles." },
      { name: 'Safina', logo: '', category: 'grocery', description: "Farines de haute qualité, semoules et produits meuniers divers." },
      { name: 'Henkel', logo: '', category: 'hygiene', description: "Produits d'entretien ménager, détergents et solutions de lavage de confiance." },
      { name: 'Cevital', logo: '', category: 'grocery', description: "Huiles végétales raffinées, sucre blanc pur et margarines de table." },
  ...
  ar: {
    ...
    partnersFilterGrocery: "البقالة والمواد الغذائية",
    partnersFilterBeverage: "المشروبات والعصائر",
    partnersFilterHygiene: "العناية والمنظفات",
    partnersDirectDist: "توزيع مباشر من المنتج",
    partnersDirectDistDesc: "علاقات مباشرة مع كبار المنتجين لتقديم أسعار تنافسية دون أي وسطاء.",
    partnersLogistic: "خدمات لوجستية معيارية",
    partnersLogisticDesc: "أسطول شاحنات حديث ومستودعات تخزين تلبي معايير النظافة والسلامة الكاملة.",
    partnersStock: "وفرة مضمونة للمنتجات",
    partnersStockDesc: "إدارة المخزون في الوقت الفعلي وإعادة التموين الفائقة لتجنب أي انقطاع للمواد.",
    ...
    PARTNERS: [
      { name: 'Famico', logo: '', category: 'grocery', description: "قهوة محمصة، قهوة سريعة الذوبان ومنتجات بقالة فاخرة." },
      { name: 'Jumbo', logo: '', category: 'grocery', description: "مرق الدجاج مكعبات، توابل ومعززات النكهة الأساسية." },
      { name: 'Amour', logo: '', category: 'grocery', description: "عجائن غذائية ذات جودة عالية، كسكس وسميد ممتاز." },
      { name: 'Sosemie', logo: '', category: 'grocery', description: "سميد القمح الصلب الممتاز وعجائن تقليدية متنوعة." },
      { name: 'Safina', logo: '', category: 'grocery', description: "فرينة عالية الجودة، سميد ومنتجات المطاحن المتنوعة." },
      { name: 'Henkel', logo: '', category: 'hygiene', description: "منتجات التنظيف المنزلي، مواد غسيل ومنظفات موثوقة." },
      { name: 'Cevital', logo: '', category: 'grocery', description: "زيوت نباتية مكررة، سكر أبيض نقي ومارغرين الطاولة." },
