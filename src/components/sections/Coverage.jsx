...
import { WILAYAS } from '../../data/content'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <SectionHeader
            ...
            title="Nous livrons partout en Algérie"
            subtitle="Depuis notre siège à Tiaret, notre réseau de livraison s'étend sur 24 wilayas, assurant un service rapide et fiable à travers l'Algérie."
          />
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-green-50 to-teal-50 border border-green-100 rounded-3xl overflow-hidden h-[440px] shadow-lg">
                ...
                <div className="relative">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <span className="text-white text-[9px] font-bold block mt-0.5">TIARET</span>
                    </div>
                  </motion.div>
              ...
              {/* Badge */}
              <div className="absolute top-4 right-4 bg-white rounded-xl shadow-md px-4 py-2 text-center">
                <div className="text-2xl font-extrabold text-green-700">24</div>
                <div className="text-xs text-gray-500 font-medium">Wilayas</div>
              </div>
              <div className="absolute bottom-4 left-4 bg-white rounded-xl shadow-md px-4 py-2 flex items-center gap-2">
                <Truck size={16} className="text-amber-500" />
                <span className="text-xs font-semibold text-gray-700">30+ véhicules</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Livraison directe dans toutes ces zones</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 mb-8">
              {WILAYAS.map((w, i) => (
                ...
                >
                  <MapPin size={13} className={w === 'Tiaret' ? 'text-amber-300' : 'text-green-600'} />
                  {w}
                  {w === 'Tiaret' && (
                    <span className="ml-auto text-[10px] bg-amber-400 text-white px-1.5 py-0.5 rounded-md font-bold">HQ</span>
                  )}
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: Truck, label: 'Livraison J+1', desc: 'Sur les wilayas prioritaires' },
                { icon: MapPin, label: 'Couverture 24/7', desc: 'Commandes disponibles en ligne' },
