...
export const STATS = [
  ...
  { value: 24, suffix: ' Wilayas', label: 'Couverture Régionale' },
...
export const SERVICES = [
  ...
  },
  {
    ...
    description: 'Couverture de 24 wilayas avec un réseau de livraison dense et fiable centré sur Tiaret.',
    color: 'red',
  },
]
...
export const WHY_US = [
  ...
  },
  {
    icon: 'Shield',
    title: 'Réseau Fiable',
    description: 'Plus de 10 ans d\'expérience et une présence établie dans 24 wilayas algériennes.',
  },
  {
    icon: 'TrendingDown',
...
export const GALLERY_IMAGES = [
  ...
  {
    src: 'https://images.unsplash.com/photo-1578574577315-3fbeb0cecdc2?w=600&q=80',
    alt: 'Rayons produits',
    category: 'Produits',
  },
  {
  ...
  },
  {
    ...
    alt: 'Livraison de marchandises',
    category: 'Livraison',
  },
  {
    src: 'https://images.unsplash.com/photo-1609767419893-2d0d45e55a9b?w=600&q=80',
...
export const WILAYAS = [
  'Tiaret', 'Alger', 'Oran', 'Constantine', 'Annaba', 'Sétif',
  'Blida', 'Batna', 'Médéa', 'Tlemcen', 'Mostaganem', 'Relizane',
  'Mascara', 'Saïda', 'Djelfa', 'M\'Sila', 'Bouira', 'Tizi Ouzou',
  'Béjaïa', 'Jijel', 'Chlef', 'Aïn Defla', 'Tissemsilt', 'Khenchela',
]
